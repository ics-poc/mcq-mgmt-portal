...
import {
    Box, Paper, Typography, Button, Stack, Divider, Chip, Dialog,
    DialogTitle, DialogContent, DialogActions, RadioGroup, FormControlLabel,
    Radio, FormControl, LinearProgress, CircularProgress
} from '@mui/material';
import { useAuth } from '../../AuthContext';
import { api } from '../../api';

export default function ExamPage({ examDetails, onComplete }) {
    ...
    useEffect(() => {
        ...
        if (CANDIDATE_ID && examDetails?.managerTemplateId) {
            loadExam();
        }
    ...
    }, [timeLeft, loading, examData]); // eslint-disable-line react-hooks/exhaustive-deps
